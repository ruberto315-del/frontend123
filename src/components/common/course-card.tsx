  ...
  return (
    <article className="group relative h-full">
        ...
        <div className="relative p-7 lg:p-8 flex flex-col h-full">
            ...
            <h2 className="text-2xl lg:text-[1.65rem] font-black text-text-primary mb-4 text-balance leading-tight tracking-tight group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-primary group-hover:to-secondary transition-all duration-300"></h2>
        ...
        <Button variant="outline" className="h-15 bg-muted-foreground/10">Детальна інформація</Button>
        </div>
        </div>
